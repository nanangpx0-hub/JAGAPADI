...
/* ALL HOVER EFFECTS DISABLED FOR ACTION BUTTONS */
.btn-action:hover {
...
/* Enhanced tooltip - DISABLED HOVER TRANSITION */
.btn-action::after {
    content: attr(title);
    position: absolute;
    bottom: calc(100% + 8px);
...
.btn-action:hover::after {
    /* Tooltip visible on hover - DISABLED */
}
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <button id="btnBulkDelete" class="btn btn-danger btn-sm mr-2" style="display: none; opacity: 0; transform: translateY(-10px); transition: all 0.3s ease;">
                        <i class="fas fa-trash"></i> Delete All (<span id="selectedCount">0</span>)
                    </button>
                    <?php endif; ?>
